...
const faqs = [
  {
    question: "คำนวณไทยช่วยไทยพลัสเว็บนี้ใช้ทำอะไร?",
    answer:
      "เว็บนี้ช่วยคำนวณไทยช่วยไทยพลัสจากเงินรัฐที่เหลือหรือราคาสินค้า เพื่อดูว่ายอดซื้อควรไม่เกินกี่บาท รัฐช่วยจ่ายเท่าไหร่ และเราจ่ายเองเท่าไหร่",
  },
  {
      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="mt-4 space-y-4 leading-7 text-slate-700">
            ...
            <p>
              หากค้นหาว่าเว็บคำนวณไทยช่วยไทยพลัส หรือคำนวณไทยช่วยไทยพลัสเว็บนี้ หน้านี้ตั้งใจให้ตอบโจทย์การคำนวณเร็ว ๆ
              ทั้งฝั่งผู้ใช้สิทธิและร้านค้าถุงเงิน โดยไม่ต้องกดเครื่องคิดเลขเองหลายรอบ
            </p>
            <p>
